...
*For more information on the LCD, see its [main page](./lcd)*
...
*For more information on the cartridge, see its [main page](./cartridge.md)*
...
*For more information on the keypad, see its [main page](./cpu/io.md#dedicated-inputs)*
...
*For more on how to use the rumble motor, see [here](./cpu/io.md#rumble)*
...
*For more information, see its [main page](./cpu/sound.md)*
...
*For more information on the C button, see the [keypad page](./cpu/io.md#dedicated-inputs)*
...
*For more on how to use the shock sensor, see [here](./cpu/io.md#shock)*
...
*For more information on the CPU, see its [main page](./cpu)*
...
*For more information, see its [main page](./ir.md)*
...
*For more information, see [OSC1](./cpu/timers.md#osc1)*
...
*For more information, see [OSC3](./cpu/timers.md#osc3)*
