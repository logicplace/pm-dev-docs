...
As part of [MINLIB](/software/minlib.md), most games have a method which stores the keypad data to RAM which they poll in order to check for player input. The method looks something like this:
